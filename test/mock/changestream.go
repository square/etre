...
var RawInsertEvents = []bson.M{
	bson.M{
		"_id":         bson.M{"_data": bson.Binary{Data: []uint8{0x82, 0x5e, 0x8f, 0x5c, 0xf7, 0x0, 0x0, 0x0, 0x26, 0x46, 0x3c, 0x5f, 0x69, 0x64, 0x0, 0x3c, 0x61, 0x62, 0x63, 0x0, 0x0, 0x5a, 0x10, 0x4, 0x4d, 0x5e, 0xa3, 0x2c, 0x5c, 0x27, 0x4c, 0xf8, 0xb1, 0xad, 0x80, 0x30, 0x3a, 0x44, 0xbc, 0x82, 0x4}}},
		"documentKey": bson.M{"_id": "abc"},
		"fullDocument": bson.M{ // etre.CDCEvent
			"_id":        "abc",
			"entityId":   "e13",
			"entityType": "node",
			"op":         "i",
			...
			"ts":         54,
			"user":       "mike",
			"new":        bson.M{"_id": "e13", "_rev": int64(7), "_type": "node", "foo": "bar"},
		},
		"ns":            bson.M{"coll": "cdc", "db": "etre_test"},
