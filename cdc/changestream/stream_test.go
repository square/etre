...
func setup(t *testing.T, srv changestream.Server, store cdc.Store) *changestream.ServerStreamer {
	return changestream.NewServerStreamer(srv, store)
}
...
func TestStreamNow(t *testing.T) {
	...
	stream := setup(t, srv, &mock.CDCStore{})
